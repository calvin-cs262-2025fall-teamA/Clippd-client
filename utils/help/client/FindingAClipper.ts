/**
 * @fileoverview Help document: Finding a Clipper (Client)
 * @description Instructions for clients on how to find and browse clippers
 * @version 1.0.0
 */
...
/**
 * Finding a Clipper help document for clients
 * @type {HelpDocument}
 */
