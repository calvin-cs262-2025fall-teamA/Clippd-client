...
type CardProps = {
  ...
  profilePic?: string; // a URL string (or path when database?)
};

export default function Card({ name, location, images, rating, profilePic }: CardProps) {
      ...
      <View style={styles.photoFrame}>
        ...
        <>
          ...
          {images.map((_, index) => (
            <Text
              key={index}
              style={index === activeIndex ? styles.pagingDotActive : styles.pagingDot}
            >
              •
            </Text>
          ))}
        ...
        <Text style={styles.title}>{name}</Text>
          ...
          {location && 
            (<View style={styles.locationRow}>
              ...
              <Ionicons name="location-sharp"></Ionicons>{location}
              </Text>
            </View>
          )}
        </View>
